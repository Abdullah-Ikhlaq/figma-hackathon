  ...
  return (
    <div className='relative mx-auto md:w-[1440px] md:h-[2827px] w-[390px] h-[3579px]'>
        ...
        <div className="mt-[6rem] w-[390px] h-[1055px] bg-white flex flex-col md:mt-[8rem] md:flex-row md:gap-[2rem] md:w-[1440px] md:h-[759px]">
                 ...
                 <div className="md:h-[657px] md:w-[602px] md:m-[2rem] w-[390px] h-[675px] p-[1.5rem]">
                    <div className="flex mt-2 flex-col gap-[12px]">
                        <h3 className="font-clash font-normal leading-[33.6px] text-darkPrimary text-[1.6rem] md:text-5xl">{details.heading}</h3>
                        <h4 className="font-clash font-normal leading-7 mt-1 md:mt-0 text-darkPrimary text-xl md:text-4xl"> &#163; {details.price}</h4>
                    </div>
                    <div className="flex mt-4 md:mt-10 flex-col gap-[12px]">
                        <h5 className="font-clash font-normal leading-[22.4px] text-darkPrimary text-lg md:text-2xl">Product description</h5>
                        <p className="font-satoshi font-normal text-darkPrimary leading-[21px] text-[16px] md:text-lg">{details.para}</p>
                        <ul className="list-disc mt-1 mb-4">
                            <li className="font-satoshi marker:leading-[21px] text-darkPrimary font-normal md:text-lg">Premium material</li>
                            <li className="font-satoshi marker:leading-[21px] text-darkPrimary md:text-lg font-normal">Handmade upholstery</li>
                            <li className="font-satoshi marker:leading-[21px] md:text-lg text-darkPrimary font-normal">Quality timeless classic</li>
                        </ul>
                    </div>
                    <div>
                        <h5 className="font-clash font-normal leading-[22.4px] text-darkPrimary text-lg md:text-2xl mt-4">Dimensions</h5>
                        <div className="mt-4 flex justify-between gap-6">
                            <h6 className="font-normal font-clash leading-[19.6px] text-darkPrimary md:text-lg">Height</h6>
                            <h6 className="font-normal font-clash leading-[19.6px] text-darkPrimary md:text-lg">Width</h6>
                            <h6 className="font-normal font-clash leading-[19.6px] text-darkPrimary md:text-lg">Depth</h6>
                        </div>
                        <div className="flex justify-between mt-3">
                            <h6 className="font-normal font-clash leading-[19.6px] text-darkPrimary md:text-lg">110cm</h6>
                            <h6 className="font-normal font-clash leading-[19.6px] text-darkPrimary md:text-lg">75cm</h6>
                            <h6 className="font-normal font-clash leading-[19.6px] text-darkPrimary md:text-lg">50cm</h6>
                        </div>
                    </div>
                    <div className=" mt-2 flex flex-col md:flex-row gap-[12px] md:gap-4">
                    <h5 className="relative mt-2 font-clash font-normal leading-[22.4px] text-darkPrimary text-lg md:text-2xl md:top-10">Quantity</h5>
      ...
      >
        ...
        <p className="mt-[10rem] leading-[24.6px] text-darkPrimary font-clash font-normal text-xl md:text-3xl">You might also like</p>
