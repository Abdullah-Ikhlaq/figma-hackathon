  ...
  return (
    <div className="relative  flex flex-col w-full lg:h-[2439px] md:h-[2439px] product-sec">
      ...
      <div className="relative w-full lg:h-[2439px] h-[146px] ">
        ...
        />
        <h1 className="font-clash font-normal leading-[50.4px] text-white text-3xl lg:text-[2.1rem] absolute top-[3.5rem] lg:top-[7.7rem]  lg:left-[4.5rem] left-[6rem] md:text-[1.5rem] md:top-[5.1rem] md:left-[3.45rem]"> 
          All products
        </h1>
      </div>
      ...
      <div className="relative lg:bottom-[50rem] h-[625px] grid grid-cols-2 lg:grid-cols-4 gap-[2rem] lg:mx-3.5 lg:gap-[2rem] gap-y-[8rem] md:gap-0 md:pr-32 lg:pr-0 lg:gap-y-[8rem] md:gap-y-[6rem] mt-[6rem] md:mt-20 md:mx-auto product-sec-card">
        <ProductCard
          image="Vase"
      ...
      <div className="relative lg:bottom-[25rem] hidden lg:grid lg:grid-cols-4 gap-y-[4rem] lg:gap-[2rem] lg:mx-3.5 product-sec-card">
        <ProductCard
          image="goldenLamp"
          heading="Rustic Vase Set"
          price="155"
      ...
      <div className="relative lg:bottom-[22rem] h-[625px] grid grid-cols-2 lg:grid-cols-4 gap-[2rem] md:gap-0 md:pr-32 lg:pr-0 md:gap-y-[6rem] gap-y-[8rem] lg:gap-[2rem] mt-[20rem] lg:mx-3.5 md:mt-[25rem] lg:mt-[20rem] md:mx-auto product-sec-card">
        <ProductCard
          image="Vase"
          heading="Rustic Vase Set"
          price="155"
