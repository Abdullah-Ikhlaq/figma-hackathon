...
const FeatureCard: React.FC<CardProps> = ({image, heading, para}) => {
  return (
    ...
    <h5 className='font-clash font-normal leading-[22.4px] text-darkPrimary text-2xl'>{heading}</h5>
    <p className='font-satoshi font-normal leading-[21px] text-darkPrimary md:text-lg'>{para}</p>
 </div>
  );
};
