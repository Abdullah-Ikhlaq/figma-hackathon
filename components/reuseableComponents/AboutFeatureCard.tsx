...
const AboutFeatureCard: React.FC<CardProps> = ({ image, heading, para }) => {
  return (
    <div className="p-8 flex border border-transparent flex-col gap-4 hover:bg-gray-300 hover:border-darkPrimary transition-all duration-300 ease-in-out rounded bg-lightGray">
      <Image
