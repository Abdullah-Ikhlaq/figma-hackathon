    ...
    <div className='relative md:w-[1440px] md:h-[300] w-[390px] h-[720px] bottom-4 bg-darkPrimary gap-8 md:py-[6rem] md:px-[2rem]'>
       ...
       <div className='grid grid-cols-2 md:grid-cols-3 gap-6 px-6 py-10 md:gap-[4rem]'>
        ...
        <div className='md:relative md:left-[4rem] md:top-[3rem]'>
            <div className='ml-8 md:ml-0'><FooterHeading name='Join our mailing list'/></div>
            <div className='mt-4 flex justify-center pb-6 border-b border-[#4e4d93] md:border-darkPrimary'>
            <input type="email" placeholder='your@email.com' className='bg-white bg-opacity-[15%] placeholder:font-satoshi focus:outline-none py-4 px-5 placeholder:text-white md:w-[500px]'/>
            <button className='px-[32px] py-[16px] bg-white text-[#2A254B] font-satoshi font-normal leading-6 hover:bg-navbarColor hover:text-lightGray'>Sign up</button>
        </div>
</div>
       </div>
      <div className='md:flex md:justify-between'>
      <p className='text-center  font-satoshi font-normal leading-[18.9px] text-white mt-6 md:text-lg md:mt-8'>Copyright 2022 Avion LTD</p>
