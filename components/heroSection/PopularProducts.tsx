...
const PopularProducts = () => {
  return (
    <div className="relative mt-[14rem] h-[573px] md:h-[744px] bg-white md:px-[2rem] mx-auto lg:px-0 lg:mx-[1.5rem] md:mt-0 lg:top-[20rem] popular-product">
      ...
      <div className="relative hidden md:bottom-[8rem] md:h-[375px] md:flex gap-[30px] hero-popular">
        ...
        >
          <Image
            ...
            width={200}
            height={200}
            className="w-[630px] h-[375px] hero-popular-products"
          />
