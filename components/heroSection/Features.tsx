...
const Features = () => {
  return (
    <div className='relative md:w-[1440px] md:h-[335px] mt-[8rem] w-[390px] h-[757px] bg-white flex flex-col gap-[2rem] md:justify-center md:items-center'>
         <h4 className='px-8 font-clash text-2xl font-normal leading-[28px] md:text-3xl'>What makes our brand different</h4>
...
<FeatureCard image='Checkmark' heading='Made by true artisans' para='Handmade crafted goods made with real passion and craftmanship' />
