...
const Features = () => {
  return (
    <div className="relative lg:w-[1290px] md:w-[890px] lg:h-[335px] mt-[8rem] w-[390px] h-[757px] bg-white flex flex-col gap-[2rem] md:gap-0 lg:gap-[2rem] lg:justify-center lg:mx-8 lg:items-center md:mx-auto">
