...
const AboutSection = () => {
  return (
    <div className='relative w-[390px] h-[385px] py-[32px] px-[24px] my-[3rem] flex flex-col md:flex-row md:w-[1440px] md:h-[277px] md:px-[12rem] md:py-[2rem] md:gap-[12rem]'>
        <h2 className='font-clash font-normal leading-[44.8px] text-darkPrimary text-3xl md:w-[704px]'>A brand built on the love of craftmanship, quality and outstanding customer service</h2>
