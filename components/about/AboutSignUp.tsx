const AboutSignUp = () => {
  return (
    <div className="relative top-[50rem] lg:top-[27.5rem] md:top-[40rem] h-[292px] w-full md:h-[481px] md:mt-[8rem] md:border-[3.5rem] md:border-lightGray bg-white p-4 bottom-[5rem] md:mx-auto lg:mx-5 md:justify-center md:items-center lg:justify-normal lg:items-start">
