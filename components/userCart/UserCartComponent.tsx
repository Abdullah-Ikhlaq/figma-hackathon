...
const UserCartComponent = () => {
  return (
    <div className="bg-lightGray h-[1466px] mx-auto w-[390px] md:w-[1440px] md:h-[749px] md:px-[5rem] md:py-[2rem] py-4 px-6">
...
one for the classics." />
  ...
  <div className="text-right h-[62px] mt-8 lg:pr-28">
  ...
  <button className="relative w-[342px] h-[56px] px-[32px] py-[16px] bg-darkPrimary font-satoshi font-normal leading-[24px] text-white hover:bg-navbarColor mt-12 lg:left-[60.6rem] lg:w-[200px] lg:bottom-10">
  Go to checkout
  </button>
    </div>
  );
